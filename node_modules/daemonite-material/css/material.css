...
.blockquote-reverse {
    border-left: 0;
    border-right: .3125rem solid #9c27b0;
    text-align: right
}
...
.breadcrumb-item+.breadcrumb-item::before {
    background-image: url("data:image/svg+xml;charset=utf8,%3Csvg fill='#000000' fill-opacity='0.54' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z'/%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3C/svg%3E");
...
@media (-webkit-transform-3d) and (min-width:600px) {
    .carousel-item {
        -webkit-transition-duration: .39s;
        -o-transition-duration: .39s;
        transition-duration: .39s
...
@media (-webkit-transform-3d) and (min-width:1280px) {
    .carousel-item {
        -webkit-transition-duration: .2s;
        -o-transition-duration: .2s;
        transition-duration: .2s
...
.carousel-control-next:active .carousel-control-prev-icon,
...
.carousel-control-prev:active .carousel-control-next-icon,
...
.carousel-control-next-icon {
    background-image: url("data:image/svg+xml;charset=utf8,%3Csvg fill='#000000' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z'/%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3C/svg%3E")
}

.carousel-control-prev-icon {
    background-image: url("data:image/svg+xml;charset=utf8,%3Csvg fill='#000000' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z'/%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3C/svg%3E")
}
...
.custom-file-control::before {
    background-color: transparent;
    background-image: url("data:image/svg+xml;charset=utf8,%3Csvg fill='#000000' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2 12.5C2 9.46 4.46 7 7.5 7H18c2.21 0 4 1.79 4 4s-1.79 4-4 4H9.5C8.12 15 7 13.88 7 12.5S8.12 10 9.5 10H17v2H9.41c-.55 0-.55 1 0 1H18c1.1 0 2-.9 2-2s-.9-2-2-2H7.5C5.57 9 4 10.57 4 12.5S5.57 16 7.5 16H17v2H7.5C4.46 18 2 15.54 2 12.5z'/%3E%3Cpath d='M0 0h24v24H0V0z' fill='none'/%3E%3C/svg%3E");
    background-position: 50% 50%;
    background-repeat: no-repeat;
    -webkit-background-size: 24px 24px;
    background-size: 24px 24px;
...
.form-group:not(.floating-label) label:not(.form-check-label) {
    font-size: .75rem;
    margin-bottom: 0
}
...
.floating-label-lg>.custom-select+.form-control-feedback,
.floating-label-lg>.custom-select+.form-text,
.floating-label-lg>.form-control+.form-control-feedback,
.floating-label-lg>.form-control+.form-text,
.form-control-lg+.form-control-feedback,
.form-control-lg+.form-text,
.form-control-static-lg+.form-control-feedback,
.form-control-static-lg+.form-text,
.input-group-lg>.custom-select+.form-control-feedback,
.input-group-lg>.custom-select+.form-text,
.input-group-lg>.form-control+.form-control-feedback,
.input-group-lg>.form-control+.form-text {
    margin-top: .75rem
}

.floating-label-sm>.custom-select+.form-control-feedback,
.floating-label-sm>.custom-select+.form-text,
.floating-label-sm>.form-control+.form-control-feedback,
.floating-label-sm>.form-control+.form-text,
.form-control-sm+.form-control-feedback,
.form-control-sm+.form-text,
.form-control-static-sm+.form-control-feedback,
.form-control-static-sm+.form-text,
.input-group-sm>.custom-select+.form-control-feedback,
.input-group-sm>.custom-select+.form-text,
.input-group-sm>.form-control+.form-control-feedback,
.input-group-sm>.form-control+.form-text {
    margin-top: .25rem
}
...
.popover {
    ...
    -webkit-box-shadow: 0 24px 38px 3px rgba(0, 0, 0, .14), 0 9px 46px 8px rgba(0, 0, 0, .12), 0 11px 15px -7px rgba(0, 0, 0, .4);
    box-shadow: 0 24px 38px 3px rgba(0, 0, 0, .14), 0 9px 46px 8px rgba(0, 0, 0, .12), 0 11px 15px -7px rgba(0, 0, 0, .4);
    display: block;
    font-size: .875rem;
    max-width: 17.5rem;
    position: absolute;
...
@media (min-width:600px) {
    .fade {
        -webkit-transition-duration: .2925s;
        -o-transition-duration: .2925s;
...
@media (min-width:600px) {
    .fade.show {
        -webkit-transition-duration: .4875s;
        -o-transition-duration: .4875s;
...
.btn-block+.btn-block,
.card-actions.flex-column .btn+.btn,
.card-actions.flex-column-reverse .btn+.btn {
    margin-top: .25rem
}
...
.dropdown.open>.btn.dropdown-toggle::before {
    border-bottom-right-radius: 0;
    border-bottom-left-radius: 0
}

.dropup.open>.btn.dropdown-toggle,
.dropup.open>.btn.dropdown-toggle::before {
...
.btn-float.active,
.btn-float:active {
    -webkit-box-shadow: 0 12px 16px 1px rgba(0, 0, 0, .14), 0 4px 22px 3px rgba(0, 0, 0, .12), 0 6px 7px -4px rgba(0, 0, 0, .4);
    box-shadow: 0 12px 16px 1px rgba(0, 0, 0, .14), 0 4px 22px 3px rgba(0, 0, 0, .12), 0 6px 7px -4px rgba(0, 0, 0, .4);
    z-index: 120
}
...
.card-actions.flex-column .btn,
.card-actions.flex-column-reverse .btn,
.card-header-pills.flex-column .nav-item,
.card-header-pills.flex-column .nav-link,
.card-header-pills.flex-column-reverse .nav-item,
.card-header-pills.flex-column-reverse .nav-link {
    display: table
}
...
.card-header-pills .nav-item+.nav-item,
.card-header-pills .nav-link+.nav-link {
    margin-left: .5rem
}
...
.card-header-pills.flex-column .nav-item+.nav-item,
.card-header-pills.flex-column .nav-link+.nav-link,
.card-header-pills.flex-column-reverse .nav-item+.nav-item,
.card-header-pills.flex-column-reverse .nav-link+.nav-link {
    margin-top: .25rem;
    margin-left: 0
}
...
@media (min-width:600px) {
    ...
    .card-group .card:first-child .card-actions,
    ...
    .card-group .card:last-child .card-actions,
...
.card-block:not(:first-child)>.card-title:first-child {
    margin-top: .5rem
}

.card-img-top+.card-block>.card-title:first-child {
    margin-top: 0
}
...
a.badge:active::before,
a.badge:focus::before,
a.badge:hover::before,
a.chip:active::before,
a.chip:focus::before,
a.chip:hover::before {
    opacity: 1
}
...
a.badge-inverse,
a.badge-inverse:active,
a.badge-inverse:focus,
a.badge-inverse:hover,
a.chip-inverse,
a.chip-inverse:active,
a.chip-inverse:focus,
a.chip-inverse:hover {
    color: #fff
}
...
a.chip-primary,
a.chip-primary:active,
a.chip-primary:focus,
...
a.chip-secondary,
a.chip-secondary:active,
a.chip-secondary:focus,
a.chip-secondary:hover {
    color: #fff
}
...
a.chip-success,
a.chip-success:active,
a.chip-success:focus,
a.chip-success:hover,
a.chip-warning,
a.chip-warning:active,
a.chip-warning:focus,
a.chip-warning:hover {
    color: rgba(0, 0, 0, .87)
}
...
.show>.dropdown-menu {
    ...
    -o-animation-name: dropdown-open;
...
@-webkit-keyframes dropdown-open {
    0% {
        opacity: 0;
        top: 50%;
        -webkit-transform: scale(.87, .54);
        transform: scale(.87, .54)
    }
    50% {
        opacity: 1
    }
...
@-o-keyframes dropdown-open {
    0% {
        opacity: 0;
        top: 50%;
        -o-transform: scale(.87, .54);
        transform: scale(.87, .54)
    }
    50% {
        opacity: 1
...
.dropup.show>.dropdown-menu {
    -webkit-animation-name: dropup-open;
    -o-animation-name: dropup-open;
    animation-name: dropup-open
}

@-webkit-keyframes dropup-open {
    0% {
        opacity: 0;
        bottom: 50%;
        -webkit-transform: scale(.87, .54);
...
.dropdown-menu-sm .menu-item,
.menu-cascading .dropdown-item,
.menu-cascading .menu-item {
...
.dropdown-menu-sm .menu-header,
.menu-cascading .dropdown-header,
.menu-cascading .menu-header {
    padding: .25rem 1.5rem
}
...
.picker__header,
.picker__nav--next,
.picker__nav--next.material-icons,
.picker__nav--prev,
.picker__nav--prev.material-icons {
    line-height: 2.5rem
}
...
@media (min-width:600px) {
    .picker__holder {
        -webkit-transition-delay: .2925s;
        -o-transition-delay: .2925s;
        transition-delay: .2925s
    }
}
...
.picker__input[readonly].custom-select {
...
.progress-bar::before {
    ...
    background-image: -o-linear-gradient(left, rgba(255, 255, 255, .7), rgba(255, 255, 255, .7));
...
.progress-bar-striped {
    border-right: .75rem solid rgba(255, 255, 255, .7);
    -webkit-box-sizing: content-box;
    box-sizing: content-box
}
...
.progress-bar-striped::before {
    background-color: transparent;
    background-image: -o-repeating-radial-gradient(.125rem .125rem, rgba(0, 0, 0, .12), rgba(0, 0, 0, .12) .125rem, transparent .125rem, transparent 100%);
    background-image: repeating-radial-gradient(.125rem .125rem, rgba(0, 0, 0, .12), rgba(0, 0, 0, .12) .125rem, transparent .125rem, transparent 100%);
    background-image: -webkit-repeating-radial-gradient(.125rem .125rem, rgba(0, 0, 0, .12), rgba(0, 0, 0, .12) .125rem, transparent .125rem, transparent 100%);
...
.progress-circular-inner {
    ...
    -o-animation: progress-circular-inner-rotate 5.332s cubic-bezier(.4, 0, .2, 1) infinite;
...
.progress-circular-left .progress-circular-spinner {
    ...
    -o-animation: progress-circular-spinner-left 1.333s cubic-bezier(.4, 0, .2, 1) infinite;
...
.progress-circular-right .progress-circular-spinner {
    ...
    -o-animation: progress-circular-spinner-right 1.333s cubic-bezier(.4, 0, .2, 1) infinite;
...
.custom-control-indicator:active::before {
    opacity: 1
}
...
.custom-checkbox .custom-control-indicator {
    background-image: url("data:image/svg+xml;charset=utf8,%3Csvg fill='#000000' fill-opacity='0.54' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z'/%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3C/svg%3E")
}
...
.form-control-danger::-webkit-input-placeholder {
    color: #e57373
}

.form-control-danger::-moz-placeholder {
    color: #e57373
}

.form-control-danger:-ms-input-placeholder {
    color: #e57373
}
...
.floating-label-lg>.custom-select:focus,
.floating-label-lg>.form-control:focus,
.form-control-lg:focus,
.input-group-lg>.custom-select:focus,
...
@media screen and (-webkit-min-device-pixel-ratio:0),
(min--moz-device-pixel-ratio:0) {
    .floating-label-lg>select.custom-select,
    .floating-label-lg>select.form-control,
    .input-group-lg>select.custom-select,
    .input-group-lg>select.form-control,
    select.form-control-lg {
        background-position: 100% .28125rem;
...
.floating-label-sm>.custom-select:focus,
.floating-label-sm>.form-control:focus,
.form-control-sm:focus,
.input-group-sm>.custom-select:focus,
...
@media screen and (-webkit-min-device-pixel-ratio:0),
(min--moz-device-pixel-ratio:0) {
    .floating-label-sm>select.custom-select,
    .floating-label-sm>select.form-control,
    .input-group-sm>select.custom-select,
    .input-group-sm>select.form-control,
    select.form-control-sm {
        background-position: 100% .390625rem;
...
input[type=color].custom-select,
...
input[type=time].custom-select,
input[type=time].form-control,
input[type=week].custom-select,
input[type=week].form-control {
    height: 2.25rem
}

.floating-label-lg>input[type=color].custom-select,
.floating-label-lg>input[type=color].form-control,
.floating-label-lg>input[type=date].custom-select,
.floating-label-lg>input[type=date].form-control,
.floating-label-lg>input[type=datetime-local].custom-select,
.floating-label-lg>input[type=datetime-local].form-control,
.floating-label-lg>input[type=month].custom-select,
.floating-label-lg>input[type=month].form-control,
.floating-label-lg>input[type=time].custom-select,
.floating-label-lg>input[type=time].form-control,
.floating-label-lg>input[type=week].custom-select,
.floating-label-lg>input[type=week].form-control,
.input-group-lg>input[type=color].custom-select,
.input-group-lg>input[type=color].form-control,
.input-group-lg>input[type=date].custom-select,
.input-group-lg>input[type=date].form-control,
.input-group-lg>input[type=datetime-local].custom-select,
.input-group-lg>input[type=datetime-local].form-control,
.input-group-lg>input[type=month].custom-select,
.input-group-lg>input[type=month].form-control,
.input-group-lg>input[type=time].custom-select,
.input-group-lg>input[type=time].form-control,
.input-group-lg>input[type=week].custom-select,
.input-group-lg>input[type=week].form-control,
...
.floating-label-sm>input[type=color].custom-select,
.floating-label-sm>input[type=color].form-control,
.floating-label-sm>input[type=date].custom-select,
.floating-label-sm>input[type=date].form-control,
.floating-label-sm>input[type=datetime-local].custom-select,
.floating-label-sm>input[type=datetime-local].form-control,
.floating-label-sm>input[type=month].custom-select,
.floating-label-sm>input[type=month].form-control,
.floating-label-sm>input[type=time].custom-select,
.floating-label-sm>input[type=time].form-control,
.floating-label-sm>input[type=week].custom-select,
.floating-label-sm>input[type=week].form-control,
.input-group-sm>input[type=color].custom-select,
.input-group-sm>input[type=color].form-control,
.input-group-sm>input[type=date].custom-select,
.input-group-sm>input[type=date].form-control,
.input-group-sm>input[type=datetime-local].custom-select,
.input-group-sm>input[type=datetime-local].form-control,
.input-group-sm>input[type=month].custom-select,
.input-group-sm>input[type=month].form-control,
.input-group-sm>input[type=time].custom-select,
.input-group-sm>input[type=time].form-control,
.input-group-sm>input[type=week].custom-select,
.input-group-sm>input[type=week].form-control,
...
.floating-label-lg>.form-control-static.custom-select,
.floating-label-lg>.form-control-static.form-control,
.form-control-static.form-control-lg,
.input-group-lg>.form-control-static.custom-select,
...
.floating-label-sm>.form-control-static.custom-select,
.floating-label-sm>.form-control-static.form-control,
.form-control-static.form-control-sm,
.input-group-sm>.form-control-static.custom-select,
...
.floating-label>label {
    ...
    -o-transition-property: color, top, -o-transform;
    transition-property: color, top, transform;
    transition-property: color, top, transform, -webkit-transform, -o-transform
}
...
.floating-label-lg.is-focused>label {
    -webkit-transform: scale(.352941);
    -o-transform: scale(.352941);
    transform: scale(.352941)
}
...
.floating-label-sm.is-focused>label {
    -webkit-transform: scale(.923077);
    -o-transform: scale(.923077);
    transform: scale(.923077)
}
...
.floating-label-lg>.input-group-addon.custom-select,
.floating-label-lg>.input-group-addon.form-control,
.input-group-addon.form-control-lg,
.input-group-lg>.input-group-addon,
.input-group-lg>.input-group-addon.custom-select,
.input-group-lg>.input-group-addon.form-control {
    font-size: 3.1875rem;
    min-width: 3.75rem
}

.floating-label-sm>.input-group-addon.custom-select,
.floating-label-sm>.input-group-addon.form-control,
.input-group-addon.form-control-sm,
.input-group-sm>.input-group-addon,
.input-group-sm>.input-group-addon.custom-select,
...
.floating-label-lg>.textarea-autosize.custom-select,
.floating-label-lg>.textarea-autosize.form-control,
.form-control-lg.textarea-autosize,
.input-group-lg>.textarea-autosize.custom-select,
.input-group-lg>.textarea-autosize.form-control {
    height: 3.75rem;
    min-height: 3.75rem
}

.floating-label-lg.floating-label>.textarea-autosize.custom-select,
.floating-label-lg.floating-label>.textarea-autosize.form-control,
.floating-label>.form-control-lg.textarea-autosize,
.input-group-lg.floating-label>.textarea-autosize.custom-select,
.input-group-lg.floating-label>.textarea-autosize.form-control {
    height: 4rem;
    min-height: 4rem
}

.floating-label-sm>.textarea-autosize.custom-select,
.floating-label-sm>.textarea-autosize.form-control,
.form-control-sm.textarea-autosize,
.input-group-sm>.textarea-autosize.custom-select,
.input-group-sm>.textarea-autosize.form-control {
    height: 2rem;
    min-height: 2rem
}

.floating-label-sm.floating-label>.textarea-autosize.custom-select,
.floating-label-sm.floating-label>.textarea-autosize.form-control,
.floating-label>.form-control-sm.textarea-autosize,
.input-group-sm.floating-label>.textarea-autosize.custom-select,
.input-group-sm.floating-label>.textarea-autosize.form-control {
    height: 2.75rem;
    min-height: 2.75rem
}
...
.navbar-nav .dropup.show>.nav-link {
    border-top-left-radius: 0;
    border-top-right-radius: 0
}
...
@media (max-width:599px) {
    ...
    .navbar-toggleable .navbar-collapse>:first-child {
        margin-top: .625rem
    }
...
@media (max-width:959px) {
    ...
    .navbar-toggleable-sm .navbar-collapse>:first-child {
        margin-top: .625rem
    }
...
@media (max-width:1279px) {
    ...
    .navbar-toggleable-md .navbar-collapse>:first-child {
        margin-top: .625rem
    }
...
@media (max-width:1919px) {
    ...
    .navbar-toggleable-lg .navbar-collapse>:first-child {
        margin-top: .625rem
    }
...
.navbar-toggleable-xl .navbar-collapse>:first-child {
    margin-top: .625rem
}
...
.navbar-toggler-icon {
    background-image: url("data:image/svg+xml;charset=utf8,%3Csvg fill='#000000' fill-opacity='0.87' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3Cpath d='M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z'/%3E%3C/svg%3E");
    background-repeat: no-repeat;
    background-position: 50% 50%;
    -webkit-background-size: 24px 24px;
    background-size: 24px 24px;
...
.navbar-inverse .navbar-toggler-icon {
    background-image: url("data:image/svg+xml;charset=utf8,%3Csvg fill='#ffffff' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3Cpath d='M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z'/%3E%3C/svg%3E")
}
...
.navbar .input-group .custom-select,
.navbar .input-group .form-control {
    margin-right: 0;
    margin-left: 0
}

.navbar .input-group .custom-select:first-child,
.navbar .input-group .form-control:first-child {
    padding-right: 3.75rem
}

.navbar .input-group .custom-select:not(:first-child),
...
.navbar .input-group .input-group-addon:first-child {
    left: 0
}

.navbar .input-group .input-group-addon:not(:first-child) {
    right: 0
}
...
.navbar-inverse .custom-select,
.navbar-inverse .form-control {
    background-color: rgba(255, 255, 255, .12)
}

.navbar-inverse .custom-select::-webkit-input-placeholder,
.navbar-inverse .form-control::-webkit-input-placeholder {
    color: rgba(255, 255, 255, .5)
}

.navbar-inverse .custom-select::-moz-placeholder,
.navbar-inverse .form-control::-moz-placeholder {
    color: rgba(255, 255, 255, .5)
}

.navbar-inverse .custom-select:-ms-input-placeholder,
.navbar-inverse .form-control:-ms-input-placeholder {
    color: rgba(255, 255, 255, .5)
}

.navbar-inverse .custom-select::placeholder,
